 ...
 * @author jxg4315
 */
public class JXG4315Lab4Part1c {
    ...
    public static void main(String[] args) {
        ...
        try 
        {
            ...
            outFile = new PrintWriter("JXG4315Lab4Part1c.out");
            System.out.println("Output data file is JXG4315Lab4Part1c.out");
        }
    ...
    public static void printRobotTable(String[][] robotStrs, int[][] robotInts, double[][] robotDbls, char[][] robotChars, PrintWriter outFile) {
        ...
        for ( int i = 0; i < robotInts.length; i++ )
        {
            ...
            {
                System.out.printf("%15s%7d%11s%3c%22s  %-40s\n", robotStrs[i][NAME], robotInts[i][YEAR], robotDbls[i][COST], robotChars[i][SOURCE], robotStrs[i][KIND], robotStrs[i][TITLE]);
            }
        }
